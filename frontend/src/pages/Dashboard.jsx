...
function Dashboard() {
  ...
  const fetchExpenses = async () => {
    try {
      const res = await axios.get('https://expense-manager-backend-ipad.onrender.com/api/expenses', { headers });
  ...
  const handleAdd = async (e) => {
    ...
    setError('');
    try {
      await axios.post('https://expense-manager-backend-ipad.onrender.com/api/expense', form, { headers });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://expense-manager-backend-ipad.onrender.com/api/expense/${id}`, { headers });
